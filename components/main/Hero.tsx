...
import ScrollingText from '../sub/ScrollingText'
        ...
        <div>
          <div className='flex ml-6 lg:ml-0 lg:justify-center mt-4 flex-row lg:items-center lg:mt-20'>
            ...
            <div className='text-sm lg:text-xl text-center lg:text-justify lg:pl-7 lg:pt-8 hidden lg:block'>
              ...
              <p className='text-2xl lg:text-4xl text-neutral-200 pb-2'>Prarabdha Srivastava</p>
            ...
            <div className='pl-4 lg:hidden'>
              ...
              <p className=' text-neutral-200 text-justify tracking-widest font-bold text-3xl opacity-90'>PRARABDHA</p>
              <p className=' text-neutral-200 text-justify tracking-widest font-bold text-3xl mt-1 opacity-90'>SRIVASTAVA</p>
            </div>
          ...
          <div className='max-w-screen justify-center items-center text-center flex flex-col mt-10 rounded-2xl'>
